...
The `setAttribute(name_string,value_string)` method is dangerous because it implicitly coerces the *value\_string* into the DOM attribute datatype of *name\_string*.
